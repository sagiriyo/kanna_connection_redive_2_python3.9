...
class TalentQusestInfo(BaseModel):
    talent_id: int = None
...
class BattleUnitInfo(BaseModel):
    damage: int = None
    unit_id: int = None
    unit_level: int = None
    unit_rarity: int = None
