...
CHAR_SIZE = 32
CHAR_SIZE_h = 47
font_path = str(FontPath.pcr_font.value)
...
def image_draw(msg, set_max=30 * 2):
    ...
    image = Image.new(
        mode="RGB",
        size=(LINE_CHAR_COUNT_MAX * CHAR_SIZE // 2 + 84, CHAR_SIZE_h * lines + 84),
        color=(255, 252, 245),
    )
    ...
    draw_table.rectangle(
        xy=(
            16,
            16,
            LINE_CHAR_COUNT_MAX * CHAR_SIZE // 2 + 69,
            CHAR_SIZE_h * lines + 69,
        ),
        fill=None,
        outline=(220, 211, 196),
        width=2,
